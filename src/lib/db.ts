...
const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  deepseek_provider: "ark",
  deepseek_ark_model: "deepseek-v4-flash-ga-260731",
  qwen_key: "",
...
const PRICING_SEED: [string, string, number, string, string][] = [
  ...
  ["deepseek", "deepseek-v4-flash-ga-260731", 9, "百万token", "方舟 DeepSeek V4 Flash 输出价；输入¥3/百万（各送50万免费tokens）"],
  ["deepseek", "deepseek-v4-pro-ga-260813", 27, "百万token", "方舟 DeepSeek V4 Pro 输出价；输入¥9/百万（各送50万免费tokens）"],
